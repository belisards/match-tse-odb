...
or ((doador LIKE 'IPIRANGA COMERCIAL QUIMICA%' or cpf_doador LIKE '08141847') and ano < '2000')
or (doador LIKE '%QUATTOR%' and ano < '2009')
or (doador like 'mectron%' and ano < "2011")
or (doador like '%politeno%' and ano < "2006")
or (doador like '%petroflex%' and ano < "2007")
or ((doador like '%nitrocarbono%' or doador like 'copene%') and ano < "2002")
